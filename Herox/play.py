...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• Cʜᴀɴɴᴇʟ", url=f"https://t.me/teamosmani"),
                      InlineKeyboardButton("• Group", url=f"https://t.me/osmanigroupbot"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                     photo=f"{IMG_5}",
                    caption="💬**Usage: /play Give a Title Song To Play Music or join @ribajosmani**"
                    ,
